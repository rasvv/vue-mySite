<template>
    ...
    >
      <v-btn color="primary" depressed :ripple="false" to="/vue-mysite">Обо мне</v-btn>
      <v-btn color="primary" depressed @click="onSetAlbum('mySitesLinks')" :ripple="false" to="/mysites">проекты</v-btn>
